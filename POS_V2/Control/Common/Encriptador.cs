...
namespace POS.Control.Common
{
    public class Encriptador
    {
        ...
        {
            return Encriptar(textoQueEncriptaremos, "pwd$up3rm3rc@d0sd3lp0r74l", "s@lAvz", "MD5", 1, "@1B2c3D4e5F6g7H8", 128);
        }
        ...
        {
            return Desencriptar(textoEncriptado, "pwd$up3rm3rc@d0sd3lp0r74l", "s@lAvz", "MD5",1, "@1B2c3D4e5F6g7H8", 128);
        }
