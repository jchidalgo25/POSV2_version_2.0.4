...
{
    public partial class DescuentoAPP : Telerik.WinControls.UI.RadForm
    {
        public string codigo;
        string titulo;
        public DescuentoAPP(string Titulo)
        {
            titulo = Titulo;
            InitializeComponent();
        }        
        ...
        {
            // No es necesario esta validacion por que si tiene que permitir letras y numero JCHID
        ...
        private void DescuentoPromocion_Load(object sender, EventArgs e)
        {
            ...
            this.ActiveControl = txtDescuento;
            txtDescuento.Focus();
        }
